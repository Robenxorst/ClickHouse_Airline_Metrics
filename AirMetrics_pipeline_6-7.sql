-- Этапы 6-7. Создание агрегирующих таблиц.
...
(	
	...
	-- суммирование идет по ВСЕМ полям,
...
-- Добавляем проекции, которые помогут ClickHouse получать данные в уже проагрегированном виде
...
-- За счет широкой таблицы тут никакой JOIN не требуется
